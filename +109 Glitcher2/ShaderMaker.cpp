...
static CFFGLPluginInfo PluginInfo ( 
	...
	"+109",								// *** Plugin unique ID (4 chars) - this must be unique for each plugin
	"+Glitcher2",						// *** Plugin name - make it different for each plugin 
...
// based on shader code by hornet from https://www.shadertoy.com/view/MdfGD2
...
/*	SetParamInfo(FFPARAM_MOUSEY,        "mouse Y",       FF_TYPE_STANDARD, 0.5f); m_UserMouseY = 0.5f;
